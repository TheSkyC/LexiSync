...
class PreviewDialog(QDialog):
    def __init__(self, parent, original_text, preview_text):
        super().__init__(parent)
        self.setWindowTitle(_("Pseudo-Localization Preview"))
        self.setModal(True)
        self.resize(600, 400)
        ...
        original_layout.addWidget(QLabel(_("Original Text:")))
        ...
        preview_layout.addWidget(QLabel(_("Preview:")))

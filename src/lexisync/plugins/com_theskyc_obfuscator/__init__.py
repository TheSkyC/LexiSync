...
class ObfuscatorPlugin(PluginBase):
            ...
            (
                ...
                [
                    ...
                    (
                        ...
                        lambda checked=False: self.show_settings_dialog(self.main_window),
                    ),
                ],
            )
        ]
    ...
    def obfuscate_specific_files(self):
        ...
        try:
            ...
            QMessageBox.critical(
                self.main_window, self._("Error"), self._("Failed to read file: {error}").format(error=e)
            )
    ...
    def _start_obfuscation_flow(self, code_content):
        ...
        element_count = 0
        needs_element_count = (
            options.get("obfuscate_rules") or options.get("obfuscate_indices") or options.get("obfuscate_local_indices")
        )
